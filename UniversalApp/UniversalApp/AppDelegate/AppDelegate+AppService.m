...
-(void)initUserManager{
    ...
    if([userManager loadUserInfo]){
        ...
        self.mainTabBar = [BasisTabBarController new];
...
- (void)loginStateChange:(NSNotification *)notification
{
    ...
    if (loginSuccess) {//登陆成功加载主窗口控制器
        ...
        //为避免自动登录成功刷新tabbar
        if (!self.mainTabBar || ![self.window.rootViewController isKindOfClass:[BasisTabBarController class]]) {
            self.mainTabBar = [BasisTabBarController new];
        ...
        self.mainTabBar = nil;
        BasisNavigationController *loginNavi =[[BasisNavigationController alloc] initWithRootViewController:[LoginViewController new]];
